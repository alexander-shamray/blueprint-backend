...
| `Microsoft.AspNetCore.TestHost` | MIT | `TestServer` for the host building blocks, which have no entry point for `WebApplicationFactory` to find ([§4.1](04-solution-structure.md)) |
