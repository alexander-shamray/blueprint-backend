...
`bash .claude/skills/codebase-index/scripts/cbx verify --session <tag> --json` lists everything the session
...
```bash
bash .claude/skills/codebase-index/scripts/cbx verify "billing/refund.py:3-4@3f9a2c1b7d4e8a90" --json
```
