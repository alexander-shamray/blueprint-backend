...
public class ArchitectureTests
{
    ...
    public void Nothing_but_the_composition_root_depends_on_infrastructure()
    {
        ...
        // type transitively without any Inventory.Infrastructure dependency to
        // trip on.
    ...
    /// <c>Inventory.TestSupport</c>, which carries the Migrator.
    /// </summary>
    /// <remarks>
    ...
    /// casing of the template's name, so a list naming <c>Inventory</c> reaches
    /// the new service with <c>Inventory</c> replaced rather than joined —
    ...
    /// projects is — checked across all five of Inventory's assemblies and all
