    ...
    : IClassFixture<HostSmokeTests.UnreachableInfrastructureFactory>
{
    ...
    private const string UnreachableSql =
        "Server=inventory-sql.invalid,1433;Database=Inventory;User Id=sa;" +
        "Password=not-a-real-password;Encrypt=False;Connect Timeout=1";

    private const string UnreachableRabbit = "amqp://guest:guest@inventory-rabbit.invalid:5672";
    ...
    public sealed class AuthenticatedUnreachableFactory()
        : InventoryApiFactory(UnreachableSql, UnreachableRabbit);
    ...
    public void Ready_probe_reports_the_sql_redis_and_bus_checks()
    {
        ...
        // Registered by AddMassTransit itself, not by AddInventoryInfrastructure
