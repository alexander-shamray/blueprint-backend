...
/// <c>PaymentsDbContext</c> itself would make the next <c>migrations add</c>
/// generate DDL for a table only the fixture creates, a snapshot drift
/// this keeps out of the real migration history.
/// </summary>
