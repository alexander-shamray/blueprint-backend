...
public class ArchitectureTests
{
    ...
    /// <c>Payments.TestSupport</c>, which carries the Migrator.
    /// </summary>
    /// <remarks>
    ...
    /// casing of the template's name, so a list naming <c>Payments</c> reaches
    /// the new service with <c>Payments</c> replaced rather than joined —
    ...
    /// projects is — checked across all five of Payments's assemblies and all
