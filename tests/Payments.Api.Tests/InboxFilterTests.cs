...
public sealed class InboxFilterTests(ServiceFixture fixture) : IAsyncLifetime
{
    ...
    /// registered <c>AddScoped&lt;DbContext, PaymentsDbContext&gt;()</c> here
    ...
    {
        // AddScoped<DbContext, PaymentsDbContext>() compiles, resolves and is
        ...
        // so the assertion is about AddPaymentsInfrastructure's registration.
        await using AsyncServiceScope scope = fixture.Factory.Services.CreateAsyncScope();

        DbContext resolved = scope.ServiceProvider.GetRequiredService<DbContext>();
        PaymentsDbContext own = scope.ServiceProvider.GetRequiredService<PaymentsDbContext>();
