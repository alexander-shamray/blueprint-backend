...
public sealed class MigrationRunner(PaymentsDbContext db, ILogger<MigrationRunner> logger)
{
    ...
    private static readonly Action<ILogger, Exception?> Failed =
        LoggerMessage.Define(
            ...
            "Payments migration failed; the schema may be partially applied. The job exits non-zero.");
