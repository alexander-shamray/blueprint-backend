...
/// <summary>
/// §3.2's one Catalog projection: Inventory's level per product. Mapped so
/// the migration is generated; read only by Dapper.
/// </summary>
/// <remarks>
/// §7.4's terms for a read model. There is no <c>DbSet</c>, deliberately: one
/// would invite a write path bypassing the projection's idempotent
/// <c>MERGE</c>, and <c>ApplyConfigurationsFromAssembly</c> finds this class
/// without one.
/// </remarks>
